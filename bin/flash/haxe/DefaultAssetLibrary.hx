...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("graphics/selector.png", __ASSET__graphics_selector_png);
		...
		className.set ("graphics/icons/avalanche.png", __ASSET__graphics_icons_avalanche_png);
		type.set ("graphics/icons/avalanche.png", AssetType.IMAGE);
		className.set ("graphics/icons/buster.png", __ASSET__graphics_icons_buster_png);
		type.set ("graphics/icons/buster.png", AssetType.IMAGE);
		className.set ("graphics/icons/snowball.png", __ASSET__graphics_icons_snowball_png);
		type.set ("graphics/icons/snowball.png", AssetType.IMAGE);
		className.set ("graphics/icons/reflector.png", __ASSET__graphics_icons_reflector_png);
		type.set ("graphics/icons/reflector.png", AssetType.IMAGE);
		className.set ("graphics/icons/firetackle.png", __ASSET__graphics_icons_firetackle_png);
		type.set ("graphics/icons/firetackle.png", AssetType.IMAGE);
		className.set ("graphics/icons/paralyzer.png", __ASSET__graphics_icons_paralyzer_png);
		type.set ("graphics/icons/paralyzer.png", AssetType.IMAGE);
		className.set ("graphics/icons/shotgun.png", __ASSET__graphics_icons_shotgun_png);
...
@:keep @:bind #if display private #end class __ASSET__graphics_selector_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__graphics_icons_avalanche_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__graphics_icons_buster_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__graphics_icons_snowball_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__graphics_icons_reflector_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__graphics_icons_firetackle_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__graphics_icons_paralyzer_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__graphics_icons_shotgun_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/graphics/selector.png") #if display private #end class __ASSET__graphics_selector_png extends lime.graphics.Image {}
...
@:image("assets/graphics/icons/avalanche.png") #if display private #end class __ASSET__graphics_icons_avalanche_png extends lime.graphics.Image {}
@:image("assets/graphics/icons/buster.png") #if display private #end class __ASSET__graphics_icons_buster_png extends lime.graphics.Image {}
@:image("assets/graphics/icons/snowball.png") #if display private #end class __ASSET__graphics_icons_snowball_png extends lime.graphics.Image {}
@:image("assets/graphics/icons/reflector.png") #if display private #end class __ASSET__graphics_icons_reflector_png extends lime.graphics.Image {}
@:image("assets/graphics/icons/firetackle.png") #if display private #end class __ASSET__graphics_icons_firetackle_png extends lime.graphics.Image {}
@:image("assets/graphics/icons/paralyzer.png") #if display private #end class __ASSET__graphics_icons_paralyzer_png extends lime.graphics.Image {}
@:image("assets/graphics/icons/shotgun.png") #if display private #end class __ASSET__graphics_icons_shotgun_png extends lime.graphics.Image {}
